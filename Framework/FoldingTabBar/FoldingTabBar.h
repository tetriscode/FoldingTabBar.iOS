...
// In this header, you should import all the public headers of your framework using statements like #import <FoldingTabBar/PublicHeader.h>
...
#import <FoldingTabBar/YALSpringAnimation.h>
